...
Usage:
    ...
    # Different entity
    python grpo.py entity=taylor_swift

    # Different reward function
    python grpo.py reward=binary

    # Fast testing config
    python grpo.py training=fast

    # Override specific parameters
    python grpo.py training.num_epochs=20 training.per_device_train_batch_size=4

    # Multi-run sweep
    python grpo.py --multirun entity=confucius,taylor_swift,stephen_king
"""
import torch
