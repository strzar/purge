...
Usage:
    ...
    python traverse_first_21_and_count_json_fields.py \
      --root /path/to/UNLEARNING/PURGE \
      --tokenizer-json /path/to/tokenizer.json \
      --limit 21 --first-n 100
...
if __name__ == "__main__":
    ...
    ap.add_argument("--limit", type=int, default=21, help="First how many numeric dirs to scan (default: 21)")
    ap.add_argument("--first-n", type=int, default=100, help="Only consider first M QA pairs in each file (default: 100)")
    ap.add_argument("--csv-out", type=Path, default=Path("first21_qa100_token_stats.csv"), help="CSV output path")
    args = ap.parse_args()
